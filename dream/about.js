...
(function () {
  ...
  function initAboutPointCloud(canvas, cfg) {
    if (!canvas || canvas.__aboutPcInit) return;
    canvas.__aboutPcInit = true;
...
`
    ...
    img.onerror = function () {
      console.error("AboutPointCloud: failed to load", imageUrl);
    };
    img.src = imageUrl;
  }

  initAboutPointCloud(document.getElementById(CFG.id), CFG);
})();